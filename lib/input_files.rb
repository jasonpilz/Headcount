class InputFiles
  ...
  GRAD_RATES = "High school graduation rates.csv"
  KINDERGARTEN = "Kindergartners in full-day program.csv"
  ONLINE_PUPIL_ENROLL = "Online pupil enrollment.csv"
  PUPIL_ENROLL_BY_RACE = "Pupil enrollment by race_ethnicity.csv"
  PUPIL_ENROLL = "Pupil enrollment.csv"
