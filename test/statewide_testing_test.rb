...
class StatewideTestingTest < Minitest::Test
  ...
  def test_proficient_by_race_returns_hash_with_years_pointing_to_hashes_of_subjects
    skip
  end

  def test_proficient_by_race_returns_UnknownDataError_for_unknown_race
    skip
  end

  def test_proficient_by_race_returns_percentage_values_as_three_digit_floats
    skip
  end
